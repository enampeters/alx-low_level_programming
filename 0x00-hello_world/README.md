This project, you are expected to be able to explain How to print text using printf, puts and putchar, how to get the size of a specific type using the unary operator sizeof, and how to compile using gcc.
